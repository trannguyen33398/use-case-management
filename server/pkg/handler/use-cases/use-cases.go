...
func (h *handler) Create(c *gin.Context) {
	input := request.CreateUseCasesRequest{}
	...
	err := h.controller.UseCase.Create(c, input)
...
func (h *handler) List(c *gin.Context) {
	...
	total, useCases, err := h.controller.UseCase.List(c)
	if err != nil {
		l.Error(err, "failed to get useCases list")
		c.JSON(http.StatusInternalServerError, view.CreateResponse[any](nil, nil, err, nil, ""))
		return
	}

	c.JSON(http.StatusOK, view.CreateResponse[any](view.ToUseCases(useCases), &view.PaginationResponse{Total: total}, nil, nil, ""))
}
...
func (h *handler) Detail(c *gin.Context) {
	...
	useCase, err := h.controller.UseCase.Detail(c)
	if err != nil {
		l.Error(err, "failed to get useCase detail")
		c.JSON(http.StatusInternalServerError, view.CreateResponse[any](nil, nil, err, nil, ""))
		return
	}

	c.JSON(http.StatusOK, view.CreateResponse[any](view.ToUseCase(useCase), nil, nil, nil, ""))
}
...
func (h *handler) Update(c *gin.Context) {
	...
	err := h.controller.UseCase.Update(c, input)
	if err != nil {
		l.Error(err, "failed to update useCase")
		c.JSON(http.StatusInternalServerError, view.CreateResponse[any](nil, nil, err, nil, ""))
		return
	}
