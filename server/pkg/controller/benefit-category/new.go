...
type IController interface {
	Create(c *gin.Context, input request.CreateBenefitCategoryRequest) (err error)
	List(c *gin.Context) (total int64, benefitCategory []*model.BenefitCategories, err error)
	Detail(c *gin.Context) (benefitCategory *model.BenefitCategories, err error)
	Update(c *gin.Context, input request.CreateBenefitCategoryRequest) (err error)
